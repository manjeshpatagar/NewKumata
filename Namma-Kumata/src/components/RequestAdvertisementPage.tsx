...
import { ArrowLeft, Upload, X, Calendar, Briefcase, Image as ImageIcon, Phone, Mail, MessageCircle, MapPin, FileText, Info, Sparkles, CheckCircle2, Send } from 'lucide-react';
...
export function RequestAdvertisementPage({ onBack, onSuccess }: RequestAdvertisementPageProps) {
  const { t } = useLanguage();
  const { user } = useAuth();
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!formData.requesterName || !formData.requesterPhone || !formData.adTitle || !formData.category || !formData.description) {
    ...
    console.log('Advertisement Request Submitted:', formData);
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-green-50 via-emerald-50 to-teal-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 p-4">
        <Card className="max-w-md w-full p-8 bg-white dark:bg-gray-900 border-0 rounded-3xl shadow-2xl text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
            Your advertisement request has been sent to our admin team. You'll receive a confirmation once it's reviewed and approved (usually within 24-48 hours).
          </p>
          <Button 
            onClick={onBack}
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-5 md:px-6 py-6 sm:py-8 pb-24 md:pb-28 lg:pb-32">
          ...
          <Card className="p-5 sm:p-6 mb-6 bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 border-0 rounded-3xl shadow-2xl shadow-purple-500/30 text-white relative overflow-hidden">
            ...
            <div className="relative z-10 flex items-start gap-4">
              ...
              <div className="flex-1">
                <h2 className="text-lg sm:text-xl font-bold mb-2">Professional Review Process</h2>
                <p className="text-white/90 text-sm sm:text-base leading-relaxed">
                  Only admins can publish advertisements. Fill out this form and our team will review your request within 24-48 hours. Once approved, your ad will go live automatically!
                </p>
              </div>
            </div>
          </Card>
          ...
          <Card className="p-5 sm:p-6 mb-6 bg-gradient-to-br from-amber-500 via-orange-500 to-red-500 border-0 rounded-3xl shadow-2xl shadow-orange-500/30 text-white relative overflow-hidden">
            ...
            <div className="relative z-10 flex items-center gap-3 sm:gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-base sm:text-lg mb-1">Why Request Instead of Direct Post?</h3>
                <p className="text-white/90 text-xs sm:text-sm leading-relaxed">
                  We ensure all ads are verified, professional, and meet our quality standards before publishing
                </p>
              </div>
            </div>
          </Card>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Card className="p-6 sm:p-8 bg-white dark:bg-gray-900 border-0 rounded-3xl shadow-xl shadow-gray-200/50 dark:shadow-none">
              ...
              <div className="space-y-5">
                <div>
                  <Label htmlFor="requesterName" className="text-sm sm:text-base font-semibold text-gray-900 dark:text-white mb-2 flex items-center gap-2">
                    Your Name
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    <Label htmlFor="requesterPhone" className="text-sm sm:text-base font-semibold text-gray-900 dark:text-white mb-2 flex items-center gap-2">
                      Phone Number
                      <Badge className="bg-red-100 dark:bg-red-900/20 text-red-700 dark:text-red-400 border-0 text-xs">Required</Badge>
                    </Label>
                    <Input
                  ...
                  <div>
                    <Label htmlFor="requesterEmail" className="text-sm sm:text-base font-semibold text-gray-900 dark:text-white mb-2">
                      Email (Optional)
                    </Label>
                    <Input
                      id="requesterEmail"
            ...
            <Card className="p-6 sm:p-8 bg-white dark:bg-gray-900 border-0 rounded-3xl shadow-xl shadow-gray-200/50 dark:shadow-none">
              ...
              <div className="space-y-5">
                {/* Ad Title */}
                <div>
                  <Label htmlFor="adTitle" className="text-sm sm:text-base font-semibold text-gray-900 dark:text-white mb-2 flex items-center gap-2">
                    Advertisement Title
                    <Badge className="bg-red-100 dark:bg-red-900/20 text-red-700 dark:text-red-400 border-0 text-xs">Required</Badge>
                  </Label>
                  <Input
                ...
                {/* Category */}
                <div>
                  <Label htmlFor="category" className="text-sm sm:text-base font-semibold text-gray-900 dark:text-white mb-2 flex items-center gap-2">
                    Category
                    <Badge className="bg-red-100 dark:bg-red-900/20 text-red-700 dark:text-red-400 border-0 text-xs">Required</Badge>
                  </Label>
                  <Select 
                  ...
                  >
                    <SelectTrigger id="category" className="h-12 sm:h-14 text-base rounded-2xl border-2 border-gray-200 dark:border-gray-700 focus:border-purple-500 bg-gray-50 dark:bg-gray-800 shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                    💡 Include all important details - price, location, specifications, etc.
                  </p>
                </div>

                {/* Price Range */}
                <div>
                  <Label htmlFor="priceRange" className="text-sm sm:text-base font-semibold text-gray-900 dark:text-white mb-2">
                ...
                {/* Preferred Duration */}
                <div>
                  <Label htmlFor="preferredDuration" className="text-sm sm:text-base font-semibold text-gray-900 dark:text-white mb-2">
                    Preferred Duration
                  </Label>
                  <Select 
                  ...
                  >
                    <SelectTrigger id="preferredDuration" className="h-12 sm:h-14 text-base rounded-2xl border-2 border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 shadow-sm">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="1day">1 Day</SelectItem>
                      <SelectItem value="3days">3 Days</SelectItem>
                      <SelectItem value="1week">1 Week (Recommended)</SelectItem>
                ...
                {/* Additional Notes */}
                <div>
                  <Label htmlFor="additionalNotes" className="text-sm sm:text-base font-semibold text-gray-900 dark:text-white mb-2">
            ...
            <Card className="p-6 sm:p-8 bg-white dark:bg-gray-900 border-0 rounded-3xl shadow-xl shadow-gray-200/50 dark:shadow-none">
              ...
              <div className="relative">
                ...
                />
                <div className={`border-3 border-dashed rounded-3xl p-8 sm:p-12 text-center transition-all ${
                  images.length >= 5 
                  ...
                  <Upload className={`w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-4 ${
                    images.length >= 5 ? 'text-gray-400' : 'text-purple-600 dark:text-purple-400'
                  }`} />
                  <p className={`text-base sm:text-lg font-semibold mb-2 ${
                    images.length >= 5 ? 'text-gray-500' : 'text-gray-900 dark:text-white'
                  }`}>
                    {images.length >= 5 ? 'Maximum 5 images reached' : 'Click or drag images here'}
                  </p>
                  <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">
                    {images.length >= 5 ? 'Remove images to upload more' : `PNG, JPG, WebP (Max 5 images, ${images.length}/5 uploaded)`}
                  </p>
                </div>
              </div>
            ...
            <Card className="p-6 sm:p-8 bg-gray-50 dark:bg-gray-900/50 border-2 border-gray-200 dark:border-gray-800 rounded-3xl">
              <div className="flex items-start gap-3">
                ...
                />
                <div className="flex-1">
                  <Label htmlFor="terms" className="text-sm sm:text-base text-gray-900 dark:text-white cursor-pointer leading-relaxed">
                    I understand that this is a request and the final decision to publish the advertisement rests with the admin team. I agree to provide accurate information and follow all platform guidelines.
                  </Label>
                </div>
              </div>
            </Card>
